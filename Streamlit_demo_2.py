...
# 日本の銘柄リスト
jp_tickers_dict = {'7203.T':'トヨタ自動車','9432.T':'NTT','6758.T':'ソニー','4755.T':'楽天','9984.T':'ソフトバンクグループ',\
    '9983.T':'ファーストリテイリング','6098.T':'リクルートホールディングス','5401.T':'日本製鉄','8031':'三井物産','8058.T':'三菱商事'}
